...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Використовуючи нижчевказану форму, ви можете об\'єднати обрані повідомлення в іншу тему. Ці повідомлення будуть відображатись в новій темі згідно їх часу написання.<br />Будь-ласка, введіть номер відповідної теми або натисніть "Обрати тему" для пошуку',
