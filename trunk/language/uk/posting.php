...
$lang = array_merge($lang, array(
	...
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> 'Помістіть кожен варіант на нову стрічку. Ви можете ввести < <strong>%d</strong> варіант.  Ви можете ввести до <strong>%d</strong> варіантів. Якщо ви видалите або додасте варіанти, попереднє голосування буде скинуто.',
		2	=> 'Помістіть кожен варіант на нову стрічку. Ви можете ввести не більше <<strong>%d</strong> варіантів.  Ви можете ввести до <strong>%d</strong> варіантів. Якщо ви видалите або додасте варіанти, попереднє голосування буде скинуто.',
	),
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'Ваше повідомлення містить %1$d символ. Мінімальна кількість символів, необхідна для розміщення повідомлення - %2$d.',
		2	=> 'Ваше повідомлення містить %1$d символів. Мінімальна кількість символів, необхідна для розміщення повідомлення - %2$d.',
	),
	...
	'TOO_MANY_CHARS_POST'		=> array(
		2	=> 'Ваше повідомлення містить %1$d символів. Максимально дозволена кількість символів становить %2$d.',
	),
	'TOO_MANY_CHARS_SIG'		=> array(
		2	=> 'Ваш підпис містить %1$d символів. Максимально дозволена кількість символів становить %2$d.',
	),
	...
	'WRONG_SIZE'	=> 'Зображення повинне бути не меншим %1$d завширшки, %2$d заввишки та не більшим %3$d завширшки та %4$d заввишки. Розмір відправленого зображення: %5$d завширшки та %6$d заввишки.',
));