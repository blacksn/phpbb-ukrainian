...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'DSN - назва джерела даних при встановленні з використанням ODBC. При використанні PostgreSQL, використовуйте localhost для з\'єднання з локальним сервером через доменний сокет UNIX, і 127.0.0.1 для з\'єднання через TCP.',
