...
$lang = array_merge($lang, array(
	...
	'LOCAL_URL'		=> 'Локальна адреса URL. URL-адреса повинна бути відносною до сторінки теми та не може містити ім\'я серверу або протокол, as links are prefixed with “%s”.',
  'RELATIVE_URL'	=> 'A relative URL. You can use this to match parts of a URL, but be careful: Повна вдреса URL є a valid relative URL. Якщо ви хочете використовувати relative адреси URL на вашому форумі, використовуйте LOCAL_URL token.',
