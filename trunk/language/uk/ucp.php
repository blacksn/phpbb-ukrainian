...
$lang = array_merge($lang, array(
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Ви можете вибрати аватар з числа доступних у галереї на даній конференції.',
	...
	'AVATAR_EXPLAIN'	=> 'Максимальні розміри: ширина %1$d, висота %2$d, розмір файлу %3$.2f Кб.',
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d з %1$d повідомлення зайнято',
		2	=> '%2$d з %1$d повідомлень зайнято',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папка заповнена на %3$d%% (%2$d з %1$d повідомлень)',
		2	=> 'Папка заповнена на %3$d%% (%2$d з %1$d повідомлень)',
	),
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Під час переміщення повідомлень до нової папки сталася помилка, лише %2d з %1d повідомлень було переміщено.',
		2	=> 'Під час переміщення повідомлень до нової папки сталася помилка, лише %2d з %1d повідомлень було переміщено.',
	),
